...
<div class="col-8">
    ...
    <?php if( get_field('download_file') ): ?>
        ...
        <a href="<?php the_field('download_file');?>" class="download__icon" download="letaka Download"><i class="fas fa-file-alt"></i></a>
        
        <div>
        
            <p class="heading__md font300 mb0"><?php the_field('download_prompt');?></p>
            
            <a href="<?php the_field('download_file');?>" download="letaka Download">
